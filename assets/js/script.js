// En el archivo JavaScript, comenzaremos con la captura de la información del formulario:
...
// Consultar la API con AJAX
// La función para consultar la API usando AJAX de jQuery podría verse así:
...
// Renderizar Información y 3.6 - Recorrer Datos
// La función renderHeroData puede tomar los datos de la API y mostrarlos en la página usando tarjetas de Bootstrap para la información y CanvasJS para un gráfico de pastel:
function renderHeroData(hero) {
  // Renderizar la tarjeta del superhéroe en '#hero-info'
  let output = `
